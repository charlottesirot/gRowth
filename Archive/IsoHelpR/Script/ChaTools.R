ChaTools <- R6Class("ChaTools",
                      public = list(
                        
                        ###################################################################################
                        #### Take the complement of a vector:
                        #### Input : VectR (general vector), x = the place in the vector of element picked 
                        #### Output : the place of the element that have not been picked
                        ###################################################################################
                        ...
                        ###################################################################################
                        #### is.null tested on each element of a vector
                        #### Input : x = a vecor to test 
                        #### Output : F or T
                        ###################################################################################
                        ...
                        #### Output : a list of the element that are successive
                        ###################################################################################
                        ...
                        ###################################################################################
                        #### createPlace
                        #### Input : vect and vect 2 two vectors to melt
                        #### Output : a vector of mixed of vect and vect2
                        ###################################################################################
                        ...
                        #### Output : an integer showing the value of the length of the longest vector
                        ###################################################################################
