---
title: "Creation and exploration of the quant file"
author: "Charlotte S."
date: "7 février 2018"
output: 
  html_document:
...
**Aim of this document:** This sheet has been created to generate automatically the "Quant" file based on the TCD data. Moreover some exploarion of the data are provided at the end of this document <br>
**WARNING:** Before uploading the file in this calculation sheet (put the name of the function), please check with the TCD_cleanR that the TCD.csv does **NOT** contain any error in all the **CONCLUSIONS** (this task may require several run of utilisation of the function TCD_cleanR).
<br><br>
